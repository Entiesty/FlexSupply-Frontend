...
.floats span {
  ...
  opacity: 0.3; animation: floatBob 6s ease-in-out infinite var(--d);
}
...
.card {
  ...
  border: 1px solid #fff; border-radius: 32px; padding: 50px 40px;
  box-shadow: 0 20px 50px rgba(0,0,0,0.08), 0 0 40px rgba(234, 88, 12, 0.05);
  text-align: center;
}

.logo-wrap { position: relative; width: 90px; height: 90px; margin: 0 auto 20px; }
.logo-icon {
  position: relative; background: #fff; width: 100%; height: 100%;
  border-radius: 50%; display: flex; align-items: center; justify-content: center;
  font-size: 2.8rem; box-shadow: 0 4px 15px rgba(0,0,0,0.05);
}
.logo-glow {
...
.brand { color: #7c2d12; font-size: 1.8rem; font-weight: 800; margin-bottom: 5px; }
.brand-sub { color: #9a3412; font-size: 0.85rem; opacity: 0.7; }

.rule { display: flex; align-items: center; gap: 10px; margin: 25px 0; opacity: 0.3; }
...
.field {
  ...
  background: #fff; border: 1.5px solid rgba(124, 45, 18, 0.15);
  border-radius: 16px; padding: 4px 16px; transition: all 0.3s;
}
.field:focus-within { border-color: #ea580c; box-shadow: 0 0 0 4px rgba(234, 88, 12, 0.1); }
.field input { flex: 1; border: none; outline: none; padding: 12px 0; font-size: 1rem; color: #431407; }

.submit-btn {
  width: 100%; padding: 16px; border: none; border-radius: 16px;
  background: linear-gradient(135deg, #ea580c, #f97316);
  color: #fff; font-size: 1.1rem; font-weight: bold; cursor: pointer;
  box-shadow: 0 10px 25px rgba(234, 88, 12, 0.3); transition: transform 0.2s;
}
.submit-btn:hover { transform: translateY(-2px); box-shadow: 0 12px 30px rgba(234, 88, 12, 0.4); }

.card-footer { margin-top: 25px; color: #9a3412; font-size: 0.85rem; opacity: 0.6; }
.text-btn { border: none; background: none; color: inherit; cursor: pointer; }
